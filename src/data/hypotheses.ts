...
export const HYPOTHESES: Hypothesis[] = [
  {
    ...
    holds: 'The vessel itself. A small artery with tone in its wall has two stable states over a band of tone, open and shut: once stress carries it shut, it stays shut until tone falls well below the level that closed it.',
    ...
    timescale: 'Seconds to shut or open · held as long as tone stays in the band.',
    ...
    test: 'Blinded palpation against a blinded Doppler map: do tender points sit on perforators? Then laser-speckle imaging at a release: blood flow returning over the spot within seconds, absent at a sham site, and sooner after pressure than after calm alone.',
    status: 'The hold is physically possible, and demanding: with measured wall strength and thickness, blood pressure and reflex timings, a small artery can hold itself shut, but in healthy vessels only while its tone stays well above rest; thicker walls, as in hypertension, bring that nearer rest. A hyaluronan collar cannot hold one. That a knot is a perforator, and that its state travels along the tree, is untested.',
    body: [
      ...
      'Suppose a knot is a perforator held shut. The artery is smooth muscle, and a small artery with tone in its wall is a switch: the pressure inside pushes it open, its muscle pulls it closed, and because muscle is strongest at one length, over a band of tone both open and shut are stable. A surge of stress carries it shut; it stays shut when the stress falls back, and opens only when tone falls well below the level that closed it. The nerve is the spark: a shut vessel starves its patch of skin, and when blood returns the nerve fires and the patch lights up — a foot waking, in miniature.',
      'The ring in the fascia is where the bundle is pinned and where the knot is felt; it is not the hold. The hyaluronan around the bundle is a liquid, and a liquid resists motion, not position: too weakly to hold a vessel shut (<a href="SIM">Simulation</a>). Movement matters in another way. Smooth muscle stretched and released in rhythm loses force at once, and small arteries widen after being squeezed, more after several squeezes than after one long one. The breath moves the tissue, so what it does to a knot need not be the same everywhere.',
    ...
    refs: ['taylor1987', 'saintcyr2009', 'burton1951', 'bolton1936', 'mayrovitz2026', 'ljung1975', 'clifford2006', 'segal1986', 'heine1988', 'yoshinaga2025'],
    ready: true,
  },
  {
    id: 'latch',
