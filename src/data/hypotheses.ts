...
export const HYPOTHESES: Hypothesis[] = [
  {
    ...
    test: 'Blinded palpation against a blinded Doppler map: do tender points sit on perforators? Then laser-speckle imaging at a release: a flush of blood flow over the spot within seconds, absent at a sham site, and faster and brighter after pressure than after calm alone.',
    status: 'The hold is physically possible: with measured wall strength, blood pressure and reflex timings, a small artery can hold itself shut in most plausible settings, and a hyaluronan collar cannot hold one. That a knot is a perforator, and that its state travels along the tree, is untested.',
    body: [
