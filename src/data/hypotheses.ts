...
export const HYPOTHESES: Hypothesis[] = [
  {
    ...
    who: 'proposed here',
    year: '2026',
    short: 'A knot is a perforator held shut: the small artery that rises with its veins, nerve and lymphatic through a ring in the fascia, closed by the muscle of its own wall and kept closed until tone falls or movement frees it.',
    ...
    substance: 'A small artery shut by the smooth muscle in its own wall, and beside it a cutaneous nerve whose patch of skin has run short of blood.',
    holds: 'The vessel itself. A small artery with tone in its wall has two stable states over a band of tone, open and shut: once stress carries it shut, it stays shut until tone falls well below the level that closed it. Held an hour or two, its muscle adapts to being shut, and the knot can come to hold at rest.',
    releases: 'Tone falling below the reopening threshold, with calm or with a breath that lowers drive more than it raises it; or movement reaching the wall, since rhythmic stretch cuts smooth muscle’s force and small arteries widen after being squeezed. Returning blood reaches the patch and wakes its nerve: the spark.',
    timescale: 'Seconds to shut or open · held while tone stays in the band · set within an hour or two, held at rest.',
    breath: 'Two routes, and which one does the work is open. Through drive: a deep in-breath tightens the skin’s small arteries within seconds, and they take about half a minute to ease, so an even breath keeps knots held; a breath that lowers drive more than it raises it lets them go, everywhere at once, the easiest first. Through movement: the breath moves the tissue, and movement lowers the wall’s force where it reaches, more in one place than another.',
    ...
    age: 'With age resting sympathetic tone rises and the skin’s small vessels respond less, all over the body; knots should rise with them in number and in size — first where stress is held — and children should be nearly free of them. A knot held for hours sets: old knots are the persistent ones, and flush when they go.',
    ...
    test: 'Blinded palpation against a blinded Doppler map: do tender points sit on perforators? Then laser-speckle imaging at a release: blood flow returning over the spot within seconds, absent at a sham site, and sooner after pressure than after calm alone. In a myograph, a small artery shut for four hours should stay shut at resting tone, where one shut for five minutes reopens.',
    status: 'The hold is physically possible, and demanding: with measured wall strength and thickness, blood pressure and reflex timings, a small artery can hold itself shut, but in healthy vessels only while its tone stays well above rest; thicker walls, as in hypertension, bring that nearer rest. With smooth muscle’s adaptation to a held length, as measured in arterioles, a knot held an hour or two would come to hold at rest. A hyaluronan collar cannot hold one. That a knot is a perforator, and that its state travels along the tree, is untested.',
    body: [
      ...
      'Suppose a knot is a perforator held shut. The artery is smooth muscle, and a small artery with tone in its wall is a switch: the pressure inside pushes it open, its muscle pulls it closed, and because muscle is strongest at one length, over a band of tone both open and shut are stable. A surge of stress carries it shut; it stays shut when the stress falls back, and opens only when tone falls well below the level that closed it. Held shut for an hour or two, its muscle adapts to the new length, as smooth muscle does, and the knot sets: it holds even at rest, and when at last it lets go the vessel opens wide. The nerve is the spark: a shut vessel starves its patch of skin, and when blood returns the nerve fires and the patch lights up — a foot waking, in miniature.',
      'The ring in the fascia is where the bundle is pinned and where the knot is felt; it is not the hold. It may be why these are the knots that hands and rollers find: the layers slide past a vessel pinned there, so pressure and movement would concentrate on its wall, against a firm plane. The hyaluronan around the bundle is a liquid, and a liquid resists motion, not position: too weakly to hold a vessel shut (<a href="SIM">Simulation</a>). Movement matters in another way. Smooth muscle stretched and released in rhythm loses force at once, and small arteries widen after being squeezed, more after several squeezes than after one long one. The breath moves the tissue, so what it does to a knot need not be the same everywhere.',
    ...
    refs: ['taylor1987', 'saintcyr2009', 'burton1951', 'bolton1936', 'mayrovitz2026', 'ljung1975', 'clifford2006', 'martinezlemus2004', 'syyong2008', 'segal1986', 'heine1988', 'yoshinaga2025'],
    ready: true,
  },
  {
    id: 'latch',
    ...
    status: 'An integrative theory. In pressurised skeletal-muscle arterioles the latch looks more like sustained activation than an economical hold; the claims about the brain are open. Arterioles held constricted for hours no longer relax fully: a memory any vascular view can draw on, from the muscle adapting rather than the latch.',
    body: [
  ...
  },
  {
    ...
    body: [
      'The Steccos’ group in Padua described the hyaluronan-rich loose tissue between fascial layers and proposed its densification as a source of myofascial pain (2011). Its claim is about glide: a viscous layer resists the sliding of the layers over one another, and ultrasound finds the loose sublayers thicker in chronic neck pain, thinning again with treatment (Stecco 2014).',
    ],
  ...
  },
  {
    ...
    body: [
      'John Quintner and Milton Cohen (1994) argued that the idea of myofascial pain misattributes to muscle what arises in peripheral nerves, and with Geoffrey Bove (2015) they criticised the circularity of trigger-point theory. The perforator view agrees about the nerve, and adds the vessel that travels with it.',
    ],
